                ...
                <div className="w-full">
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <p className="text-center text-gray-300 text-sm">
                            Chưa có tài khoản? 
                            <a href="/register" className="font-semibold form-link transition ml-1">Đăng ký miễn phí</a>
                        </p>
                    </form>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <button className="w-full flex items-center justify-center gap-2 p-3 rounded-lg font-bold text-white social-button google-button" disabled={isLoading}>
                        ...
                        <button className="w-full flex items-center justify-center gap-2 p-3 rounded-lg font-bold text-white social-button facebook-button" disabled={isLoading}>
