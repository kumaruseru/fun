                ...
                <aside className="col-span-12 lg:col-span-3 h-fit sticky top-8">
                    <div className="glass-pane p-4 rounded-2xl space-y-2">
                        ...
                        <nav className="flex flex-col space-y-2">
                            ...
                            <a href="/settings" className={`flex items-center gap-3 px-4 py-3 rounded-lg font-semibold transition-colors ${currentPage === 'settings' ? 'text-white bg-gray-500/20' : 'hover:bg-gray-800/50'}`}>
